...
function LandsatVisual() {
  return (
    <g>
      ...
      <path className={styles.connector} d="M194 120h56" />
      ...
      <path className={styles.connector} d="M346 120h54" />
...
function LayerAlteratorVisual() {
  return (
    <g>
      ...
      <path className={styles.connector} d="M184 118h78" />
      ...
      <path className={styles.connector} d="M385 118h54" />
...
function PoliYogaVisual() {
  return (
    <g>
      ...
      <path className={styles.connector} d="M356 136h33" />
    </g>
  );
}
...
function ClassifierVisual() {
  return (
    <g>
      ...
      <path className={styles.connector} d="M181 128h57" />
      ...
      <path className={styles.connector} d="M408 128h43" />
  ...
  return (
    <figure className={styles.visual} aria-label={`${label}: ${title}`}>
      ...
      <svg viewBox="0 0 620 238" role="img" aria-hidden="true">
        <defs>
          <marker id="additional-arrow" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto">
            <path d="M0 0 6 3.5 0 7Z" />
          </marker>
        </defs>
        {id === "landsat" && <LandsatVisual />}
        {id === "layeralterator" && <LayerAlteratorVisual />}
        {id === "poliyoga" && <PoliYogaVisual />}
        {id === "classifier" && <ClassifierVisual />}
      </svg>
